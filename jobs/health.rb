...
preprod_servers = [
    ...
    {name: 'probation-offender-search', versionUrl: 'https://health-kick.prison.service.justice.gov.uk/https/offender-search.pre-prod.delius.probation.hmpps.dsd.io/info', url: 'https://health-kick.prison.service.justice.gov.uk/https/offender-search.pre-prod.delius.probation.hmpps.dsd.io/health'},
...
dev_servers = [
    ...
    {name: 'probation-offender-search', versionUrl: 'https://offender-search.test.delius.probation.hmpps.dsd.io/info', url: 'https://offender-search.test.delius.probation.hmpps.dsd.io/health'},
