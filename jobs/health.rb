...
prod_servers = [
    ...
    {name: 'hmpps-restricted-patients', versionUrl: 'https://restricted-patients.hmpps.service.justice.gov.uk/info', url: 'https://restricted-patients.hmpps.service.justice.gov.uk/health'},
...
preprod_servers = [
    ...
    {name: 'hmpps-restricted-patients', versionUrl: 'https://restricted-patients-preprod.hmpps.service.justice.gov.uk/info', url: 'https://restricted-patients-preprod.hmpps.service.justice.gov.uk/health'},
...
dev_servers = [
    ...
    {name: 'hmpps-restricted-patients', versionUrl: 'https://restricted-patients-dev.hmpps.service.justice.gov.uk/info', url: 'https://restricted-patients-dev.hmpps.service.justice.gov.uk/health'},
