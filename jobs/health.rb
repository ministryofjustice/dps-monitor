...
prod_servers = [
    ...
    {name: 'hmpps-registers-to-delius-update', url: 'https://registers-to-delius-update.hmpps.service.justice.gov.uk/health'},
]
...
preprod_servers = [
    ...
    {name: 'hmpps-registers-to-delius-update', url: 'https://registers-to-delius-update-preprod.hmpps.service.justice.gov.uk/health'},
]
...
dev_servers = [
    ...
    {name: 'hmpps-pin-phone-monitor-api', url: 'https://pin-phone-monitor-api-dev.prison.service.justice.gov.uk/health'},
    ...
    {name: 'hmpps-registers-to-delius-update', url: 'https://registers-to-delius-update-dev.hmpps.service.justice.gov.uk/health'},
]
