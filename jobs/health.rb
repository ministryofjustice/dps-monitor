...
prod_servers = [
    ...
    {name: 'hmpps-manage-users', url: 'https://manage-users.hmpps.service.justice.gov.uk/health'},
    ...
    {name: 'pcms', url: 'https://pcms.prison.service.justice.gov.uk/health'},
    {name: 'pcms-api', versionUrl: 'https://pcms-api.prison.service.justice.gov.uk/info', url: 'https://pcms-api.prison.service.justice.gov.uk/health'},
    ...
    {name: 'hmpps-manage-adjudications', url: 'https://manage-adjudications.hmpps.service.justice.gov.uk/health'},
    {name: 'hmpps-manage-adjudications-api', versionUrl: 'https://manage-adjudications-api.hmpps.service.justice.gov.uk/info', url: 'https://restricted-patients-api.hmpps.service.justice.gov.uk/health'},
...
preprod_servers = [
    ...
    {name: 'hmpps-manage-users', url: 'https://manage-users-preprod.hmpps.service.justice.gov.uk/health'},
    ...
    {name: 'pcms', url: 'https://pcms-qa.prison.service.justice.gov.uk/health'},
    {name: 'pcms-api', versionUrl: 'https://pcms-api-qa.prison.service.justice.gov.uk/info', url: 'https://pcms-api-qa.prison.service.justice.gov.uk/health'},
    ...
    {name: 'hmpps-manage-adjudications', url: 'https://manage-adjudications-preprod.hmpps.service.justice.gov.uk/health'},
    {name: 'hmpps-manage-adjudications-api', versionUrl: 'https://manage-adjudications-api-preprod.hmpps.service.justice.gov.uk/info', url: 'https://restricted-patients-api.hmpps.service.justice.gov.uk/health'},
    ...
    {name: 'hmpps-nomis-prisoner-api', versionUrl: 'https://nomis-prsner-pp.aks-live-1.studio-hosting.service.justice.gov.uk/info', url: 'https://nomis-prsner-pp.aks-live-1.studio-hosting.service.justice.gov.uk/health'},
...
dev_servers = [
    ...
    {name: 'hmpps-manage-users', url: 'https://manage-users-dev.hmpps.service.justice.gov.uk/health'},
    ...
    {name: 'pcms', url: 'https://pcms-dev.prison.service.justice.gov.uk/health'},
    {name: 'pcms-api', versionUrl: 'https://pcms-api-dev.prison.service.justice.gov.uk/info', url: 'https://pcms-api-dev.prison.service.justice.gov.uk/health'},
    ...
    {name: 'hmpps-manage-adjudications', url: 'https://manage-adjudications-dev.hmpps.service.justice.gov.uk/health'},
    {name: 'hmpps-manage-adjudications-api', versionUrl: 'https://manage-adjudications-api-dev.hmpps.service.justice.gov.uk/info', url: 'https://restricted-patients-api.hmpps.service.justice.gov.uk/health'},
    ...
    {name: 'hmpps-nomis-prisoner-api', versionUrl: 'https://nomis-prsner-dev.aks-dev-1.studio-hosting.service.justice.gov.uk/info', url: 'https://nomis-prsner-dev.aks-dev-1.studio-hosting.service.justice.gov.uk/health'},
