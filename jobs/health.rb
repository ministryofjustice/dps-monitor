...
prod_servers = [
    ...
    {name: 'batchload', url: 'https://nomis-batchload.service.hmpps.dsd.io/health'},
    {name: 'pathfinder', url: 'https://pathfinder.service.justice.gov.uk/health/health'},
    {name: 'use-of-force', url: 'https://use-of-force.service.justice.gov.uk/health/health'},
    ...
    {name: 'case-notes-to-probation', versionUrl: 'https://case-notes-to-probation.prison.service.justice.gov.uk/info', url: 'https://case-notes-to-probation.prison.service.justice.gov.uk/health'},
...
preprod_servers = [
    ...
    {name: 'cat-tool', url: 'https://preprod.offender-categorisation.service.justice.gov.uk/health'},
    ...
    {name: 'batchload', url: 'https://nomis-batchload-preprod.service.hmpps.dsd.io/health'},
    {name: 'community-api', versionUrl: 'https://community-api-secure.pre-prod.delius.probation.hmpps.dsd.io/info', url: 'https://community-api-secure.pre-prod.delius.probation.hmpps.dsd.io/health'},
    {name: 'pathfinder', url: 'https://preprod.pathfinder.service.justice.gov.uk/health/health'},
    {name: 'use-of-force', url: 'https://preprod.use-of-force.service.justice.gov.uk/health/health'},
    ...
    {name: 'case-notes-to-probation', versionUrl: 'https://case-notes-to-probation-preprod.prison.service.justice.gov.uk/info', url: 'https://case-notes-to-probation-preprod.prison.service.justice.gov.uk/health'},
...
dev_servers = [
    ...
    {name: 'sentence-planning', url: 'https://sentence-planning-development.apps.live-1.cloud-platform.service.justice.gov.uk/health/health'},
    {name: 'licences', url: 'https://licences-dev.prison.service.justice.gov.uk/health'},
    {name: 'batchload', url: 'https://nomis-batchload-stage.hmpps.dsd.io/health'},
    ...
    {name: 'use-of-force', url: 'https://dev.use-of-force.service.justice.gov.uk/health/health'},
    {name: 'pathfinder', url: 'https://dev.pathfinder.service.justice.gov.uk/health/health'},
